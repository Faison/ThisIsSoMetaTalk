	...
	grunt.initConfig( {
		...
		sass:   {
			...
			all: {
				files: {
					...
					'assets/css/fz-project-meta.css': 'assets/css/sass/fz-project-meta.scss'
				}
			}
		},
		...
		postcss: {
			dist: {
				...
				files: { 
					...
					'assets/css/fz-project-meta.css': [ 'assets/css/fz-project-meta.css' ]
				}
			}
		},
		...
		compress: {
			main: {
				options: {
					mode: 'zip',
					archive: './release/fzp.<%= pkg.version %>.zip'
				},
				expand: true,
